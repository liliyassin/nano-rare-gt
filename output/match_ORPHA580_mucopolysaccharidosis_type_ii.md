...
| 4 | Hemgenix | AAV5 | 8.6/10 | 🟢 High | approved |
| 5 | Roctavian | AAV5 | 8.6/10 | 🟢 High | approved |
...
| Promoter availability | 1.00 | 1.0 | Validated tissue-specific promoters exist |
| Route of administration | 1.00 | 1.0 | Established delivery route to target tissue |
| **TOTAL (normalised)** | **8.83** | **10.0** | Raw sum / 18 × 10 |
...
| Promoter availability | 1.00 | 1.0 | Validated tissue-specific promoters exist |
| Route of administration | 1.00 | 1.0 | Established delivery route to target tissue |
| **TOTAL (normalised)** | **8.72** | **10.0** | Raw sum / 18 × 10 |
