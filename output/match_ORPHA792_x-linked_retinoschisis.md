# NanoGT Match Report: X-linked retinoschisis

**Disease:** X-linked retinoschisis (ORPHA:792)  
**Primary gene:** RS1  
**Gene CDS:** 672 bp  
...
- Main review flags: Narrow therapeutic window; evaluate newborn screening, presymptomatic diagnosis, or very early dosing feasibility; AAV tropism is species- and route-dependent; confirm human target-cell biodistribution rather than relying on animal tropism alone; Vector does not naturally cover all annotated disease tissues: retina.

### Disease Mechanism Evidence

**Molecular mechanism:** loss of function  
**Mechanistic detail:** Retinoschisin deficiency affecting retinal architecture  
...
**Evidence summary:** RS1 deficiency supports retinal gene addition if target retinal structure remains treatable  
...
|------|---------|--------|-------|-----------|----------|
| 1 | Luxturna | AAV2 | 7.9/10 | 🟢 High | approved |
| 2 | CPCB-RPE1 | AAV8 | 7.7/10 | 🟢 High | phase2/3 |
| 3 | Hemgenix | AAV5 | 7.7/10 | 🟢 High | approved |
| 4 | Roctavian | AAV5 | 7.7/10 | 🟢 High | approved |
| 5 | Libmeldy | LV | 7.5/10 | 🟢 High | approved |
...
- Gene CDS 672bp / cargo 4700bp (14% utilized)
...
- Disease mechanism: loss of function — Retinoschisin deficiency affecting retinal architecture
...
- Mechanism source: OMIM RS1 gene entry (https://omim.org/entry/300839)
...
- ORGANELLE TARGETING: COMPATIBLE — RS1 standard subcellular localisation; nuclear AAV delivery directly produces functional protein at the correct cellular compartment with no additional organelle-import steps required.
...
- Gene CDS 672bp / cargo 8000bp (8% utilized)
