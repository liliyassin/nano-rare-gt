# NanoGT Match Report: Angelman syndrome

**Disease:** Angelman syndrome (ORPHA:72)  
**Primary gene:** UBE3A  
**Gene CDS:** 2598 bp  
...
- Main review flags: Inheritance/mechanism may not be simple loss-of-function replacement; check dominant-negative, gain-of-function, or mitochondrial biology; Mechanism evidence is conditionally compatible with gene addition; review the listed disease-specific constraints before treating vector precedent as transferable; Dominant inheritance flagged; assess whether silencing, editing, or allele-specific strategy is needed instead of simple addition.

### Disease Mechanism Evidence

**Molecular mechanism:** genomic imprinting  
**Mechanistic detail:** Maternal UBE3A is lost by deletion or mutation; paternal UBE3A is epigenetically silenced in neurons by the SNHG14/UBE3A-ATS antisense transcript; neuronal UBE3A expression is absent from both alleles  
**Gene-addition compatibility:** conditional  
**Preferred modality class:** aav neuronal ube3a transgene addition  
**Evidence level/status:** direct / source_checked  
**Evidence summary:** Mabb AM et al. (2011 Trends Neurosci PMID 21592595) described the dual-allele loss mechanism — maternal deletion plus neuronal antisense silencing of the paternal allele; an AAV transgene under a neuronal promoter restores UBE3A expression independently of both silenced endogenous alleles  
**Evidence source:** [Mabb AM et al. 2011 Trends Neurosci PMID 21592595](https://pubmed.ncbi.nlm.nih.gov/21592595/)  
...
|------|---------|--------|-------|-----------|----------|
| 1 | OAV101-IT | AAV9 | 7.1/10 | 🟡 Medium | approved |
| 2 | Zolgensma | AAV9 | 7.1/10 | 🟡 Medium | approved |
| 3 | BMN 307 | AAV5 | 6.9/10 | 🟡 Medium | phase2 |
| 4 | Libmeldy | LV | 6.9/10 | 🟡 Medium | approved |
...
- Gene CDS 2598bp / cargo 4700bp (55% utilized)
...
- Disease mechanism: genomic imprinting — Maternal UBE3A is lost by deletion or mutation; paternal UBE3A is epigenetically silenced in neurons by the SNHG14/UBE3A-ATS antisense transcript; neuronal UBE3A expression is absent from both alleles
- Gene-addition modality compatibility: conditionally supports gene addition; review disease-specific constraints
- Mechanism evidence: Mabb AM et al. (2011 Trends Neurosci PMID 21592595) described the dual-allele loss mechanism — maternal deletion plus neuronal antisense silencing of the paternal allele; an AAV transgene under a neuronal promoter restores UBE3A expression independently of both silenced endogenous alleles
- Mechanism source: Mabb AM et al. 2011 Trends Neurosci PMID 21592595 (https://pubmed.ncbi.nlm.nih.gov/21592595/)
...
- ORGANELLE TARGETING: COMPATIBLE — UBE3A standard subcellular localisation; nuclear AAV delivery directly produces functional protein at the correct cellular compartment with no additional organelle-import steps required.
...
| Route of administration | 0.70 | 1.0 | Established delivery route to target tissue |
| Organelle targeting | 1.00 | 1.0 | Nuclear AAV delivery reaches correct subcellular compartment |
| **TOTAL (normalised)** | **6.86** | **10.0** | Raw sum / 21 × 10 (v2: 14 dimensions) |

### Rationale

- Gene CDS 2598bp / cargo 8000bp (32% utilized)
