...
|------|---------|--------|-------|-----------|----------|
| 1 | Strimvelis | LV | 7.7/10 | 🟢 High | approved |
| 2 | Skysona | LV | 6.4/10 | 🟡 Medium | approved |
| 3 | Libmeldy | LV | 6.3/10 | 🟡 Medium | approved |
| 4 | AVR-RD-01 | LV | 6.2/10 | 🟡 Medium | phase1/2 |
| 5 | BMN 307 | AAV5 | 5.4/10 | 🟡 Medium | phase2 |
...
| Promoter availability | 0.70 | 1.0 | Validated tissue-specific promoters exist |
| Route of administration | 0.90 | 1.0 | Established delivery route to target tissue |
| **TOTAL (normalised)** | **6.44** | **10.0** | Raw sum / 18 × 10 |
...
| Promoter availability | 0.70 | 1.0 | Validated tissue-specific promoters exist |
| Route of administration | 0.90 | 1.0 | Established delivery route to target tissue |
| **TOTAL (normalised)** | **6.28** | **10.0** | Raw sum / 18 × 10 |
...
| Promoter availability | 0.70 | 1.0 | Validated tissue-specific promoters exist |
| Route of administration | 0.90 | 1.0 | Established delivery route to target tissue |
| **TOTAL (normalised)** | **6.17** | **10.0** | Raw sum / 18 × 10 |
...
| Promoter availability | 0.70 | 1.0 | Validated tissue-specific promoters exist |
| Route of administration | 0.90 | 1.0 | Established delivery route to target tissue |
| **TOTAL (normalised)** | **5.39** | **10.0** | Raw sum / 18 × 10 |
