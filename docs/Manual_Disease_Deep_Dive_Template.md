...
| **Molecular mechanism** — cite evidence | Loss of function / Gain of function / Dominant-negative / Toxic gain / Mitochondrial / Unknown |
| **Gene-addition fit** — cite evidence | Compatible / Conditional / Uncertain / Incompatible |
...
> Dimensions 4, 9, 10, 11, 12, 13 depend only on *your disease/gene* — score them once here.
> Dimensions 1, 2, 3, 5, 6, 7, 8 depend on the *precedent program* you are comparing against — fill in Part D once per program.
...
|---|---|---|---|---|
| 4 | Modality Compatibility | 2.0 | Source-linked mechanism supports ordinary gene addition → **2.0** · Conditional support → **1.5** · Uncertain → **1.0** · Incompatible → **0.0** | /2.0 |
| 9 | Therapeutic Window | 2.0 | Adult/chronic onset (not irreversible) → **2.0** · Progressive childhood (not neonatal) → **1.5** · Early childhood (not neonatal) → **1.2** · Neonatal → **0.8** · Congenital/rapidly fatal → **0.5** | /2.0 |
| 10 | Cross-Correction | 1.0 | Secreted lysosomal enzyme → **1.0** · Secreted protein → **1.0** · Non-secreted lysosomal → **0.8** · Intracellular or membrane-bound → **0.2** | /1.0 |
| 11 | Immune Privilege | 1.0 | Retina → **1.0** · CNS → **0.9** · Liver → **0.8** · Muscle/Heart → **0.6** · Kidney → **0.5** · Haematopoietic → **0.3** · (uses best tissue if multi-tissue) | /1.0 |
| 12 | Promoter Availability | 1.0 | Liver → **1.0** (ApoE/hAAT, TBG) · Retina → **1.0** (VMD2, GRK1) · CNS → **0.8** (Syn1, CaMKII) · Muscle → **0.8** (MHCK7) · Haem → **0.7** · Heart → **0.6** · Kidney → **0.4** | /1.0 |
| 13 | RoA Feasibility | 1.0 | Liver (IV) → **1.0** · Muscle (IV/IM) → **0.9** · Haem (ex vivo HSC) → **0.9** · Retina (subretinal/intravitreal) → **0.8** · CNS (intrathecal/ICV) → **0.7** · Heart → **0.6** · Kidney → **0.4** | /1.0 |
...
| 4 | Modality Compatibility | 2.0 | *(Copy from Part C)* | /2.0 | |
| 5 | Inheritance | 1.0 | Exact match (AR↔AR or XL↔XL) → **1.0** · Any LOF ↔ any LOF → **0.7** · Dominant or mito vs recessive → **0.3** · Unknown → **0.5** | /1.0 | |
| 6 | Pathway Similarity | 2.0 | Exact pathway match → **2.0** · Related pathway group → **1.5** · Different pathway → **0.5** · Unknown disease pathway → **1.0** (neutral) · Groups: lysosomal_storage · coagulation · motor_neuron~myopathy · retinal · amino_acid~urea_cycle · mitochondrial | /2.0 | |
| 7 | Approval Weight | 1.0 | Approved → **1.0** · Phase 3 → **0.8** · Phase 2/3 or Withdrawn → **0.7** · Phase 2 → **0.6** · Phase 1/2 → **0.5** · Phase 1 → **0.4** | /1.0 | |
| 8 | Immunogenicity | 2.0 | Seroprevalence of **vector**: <10% → **2.0** · 10–19% → **1.5** · 20–39% → **1.0** · ≥40% → **0.5** · AAV2=55% · AAV8=30% · AAV9=22% · AAV1=20% · AAV2/6=17% · AAVrh10=10% · AAV5=9% · LV=2% | /2.0 | |
| 9 | Therapeutic Window | 2.0 | *(Copy from Part C)* | /2.0 | |
| 10 | Cross-Correction | 1.0 | *(Copy from Part C)* | /1.0 | |
| 11 | Immune Privilege | 1.0 | *(Copy from Part C)* | /1.0 | |
| 12 | Promoter Availability | 1.0 | *(Copy from Part C)* | /1.0 | |
| 13 | RoA Feasibility | 1.0 | *(Copy from Part C)* | /1.0 | |
...
| | |
|---|---|
| **Raw total** (sum dims 1–13) | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; / 20.0 |
| **Composite score** (raw ÷ 20 × 10) | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; / 10.0 |
