...
|------|---------|--------|-------|-----------|----------|
| 1 | BMN 307 | AAV5 | 7.3/10 | 🟡 Medium | phase2 |
| 2 | Libmeldy | LV | 6.9/10 | 🟡 Medium | approved |
| 3 | Hemgenix | AAV5 | 6.9/10 | 🟡 Medium | approved |
| 4 | Roctavian | AAV5 | 6.9/10 | 🟡 Medium | approved |
| 5 | Skysona | LV | 6.8/10 | 🟡 Medium | approved |
...
- Gene CDS 1179bp / cargo 4700bp (25% utilized)
...
- ORGANELLE TARGETING: VERIFY — AGXT is a peroxisomal protein. Nuclear AAV delivery is feasible; the peroxisomal targeting signal (PTS1/PTS2) must be preserved in the construct for correct organelle import.
...
- Gene CDS 1179bp / cargo 8000bp (15% utilized)
