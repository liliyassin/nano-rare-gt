...
- **Salla disease** (ORPHA:309, SLC17A5) — removed from cohort (v2 fix documented for reference; disease not in final 46-disease list)
...
| Salla disease | SLC17A5 | 8.8/10 ⚠️ | Lysosomal transporter scored as enzyme | ~6.7/10 | Protein class + cross-correction fix (disease removed from cohort v2) |
| Nephropathic cystinosis | CTNS | 6.4/10 ⚠️ | Lysosomal transporter; Strimvelis match reflects HSC delivery not per-cell renal logic | known residual | Same class issue as ML-IV; discuss in dissertation |
