...
| Raw total | 20.0 | Sum of all dimension maxima | Heuristic | Convenient normalisation denominator. | Not a trained model; weights were not fitted to outcome data. |
...
4. Source-audit every row in `data/disease_mechanisms.csv` beyond the currently checked cohort-level links.
