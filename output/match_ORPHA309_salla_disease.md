...
|------|---------|--------|-------|-----------|----------|
| 1 | ABO-101 | AAV9 | 8.2/10 | 🟢 High | phase1/2 |
| 2 | RGX-121 | AAV9 | 8.2/10 | 🟢 High | phase3 |
| 3 | AVR-RD-01 | LV | 7.9/10 | 🟢 High | phase1/2 |
| 4 | ST-920 | AAV2/6 | 7.3/10 | 🟡 Medium | phase1/2 |
| 5 | OAV101-IT | AAV9 | 7.1/10 | 🟡 Medium | approved |
...
| Promoter availability | 0.80 | 1.0 | Validated tissue-specific promoters exist |
| Route of administration | 0.70 | 1.0 | Established delivery route to target tissue |
| **TOTAL (normalised)** | **7.89** | **10.0** | Raw sum / 18 × 10 |

### Rationale

- Gene CDS 1485bp / cargo 8000bp (19% utilized)
- No tissue overlap (disease: ['CNS'], vector: ['hematopoietic', 'liver'])
- Both lysosomal proteins — cross-correction likely
- LOF inheritance — compatible for gene replacement
- Pathway match: lysosomal_storage
- Approval status: phase1/2
...
| Promoter availability | 0.80 | 1.0 | Validated tissue-specific promoters exist |
| Route of administration | 0.70 | 1.0 | Established delivery route to target tissue |
| **TOTAL (normalised)** | **7.33** | **10.0** | Raw sum / 18 × 10 |

### Rationale

- Gene CDS 1485bp / cargo 4700bp (32% utilized)
- No tissue overlap (disease: ['CNS'], vector: ['liver', 'muscle'])
- Both lysosomal proteins — cross-correction likely
- LOF inheritance — compatible for gene replacement
- Pathway match: lysosomal_storage
- Approval status: phase1/2
...
| Promoter availability | 0.80 | 1.0 | Validated tissue-specific promoters exist |
| Route of administration | 0.70 | 1.0 | Established delivery route to target tissue |
| **TOTAL (normalised)** | **7.06** | **10.0** | Raw sum / 18 × 10 |
