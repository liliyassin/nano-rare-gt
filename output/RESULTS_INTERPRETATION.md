# Results Interpretation — 46-Disease NanoGT Cohort
...
- Ranked with at least one current-catalog precedent: 45.
- Packaging hard-fail (CDS exceeds all vectors): 1 (NF1, 8,451 bp).
- High-confidence top matches: 33 of 45 diseases with a precedent.
- Medium-confidence top matches: 12 of 45 diseases with a precedent.
- Score range among top matches: 5.9/10 to 9.9/10.

## Top precedent programmes

- Libmeldy: 17 top-ranked diseases
- Skysona: 7 top-ranked diseases
- BMN 307: 5 top-ranked diseases
- Hemgenix: 3 top-ranked diseases
- Strimvelis: 3 top-ranked diseases
- OAV101-IT: 3 top-ranked diseases
- SRP-9001: 2 top-ranked diseases
- CPCB-RPE1: 2 top-ranked diseases
- Luxturna: 2 top-ranked diseases
- AT132: 1 top-ranked disease

## Vector classes represented in top matches

- LV: 27 top-ranked diseases
- AAV5: 8 top-ranked diseases
- AAV9: 5 top-ranked diseases
- AAV8: 3 top-ranked diseases
- AAV2: 2 top-ranked diseases

The top-match distribution is heavily concentrated in integrating ex vivo HSC-vector programmes (Libmeldy, Skysona, and Strimvelis together account for 27 of 45 matched diseases; Strimvelis is gammaretroviral, while Libmeldy and Skysona are lentiviral). This is a finding and a limitation. It indicates that the current surrogate catalogue has strong coverage for lysosomal/leukodystrophy-like, CNS neuronal, haematopoietic, hepatic metabolic, and retinal disease spaces, but much weaker coverage for kidney, cardiac, peripheral nerve, mitochondrial, dominant-negative, and large-gene biology.
...
- Chronic neurovisceral acid sphingomyelinase deficiency (SMPD1): Libmeldy / LV at 8.8/10
- Alpha-mannosidosis (MAN2B1): Libmeldy / LV at 8.8/10
- Tay-Sachs disease (HEXA): Libmeldy / LV at 8.5/10
- Pompe disease (GAA): Libmeldy / LV at 8.4/10
- Biotinidase deficiency (BTD): Libmeldy / LV at 8.3/10
- Canavan disease (ASPA): Libmeldy / LV at 8.1/10
- Niemann-Pick disease type C (NPC1): Libmeldy / LV at 8.1/10
- Nephropathic cystinosis (CTNS): Libmeldy / LV at 6.6/10
- Tuberous sclerosis complex (TSC1/TSC2): Libmeldy / LV at 6.4/10
...
- Primary hyperoxaluria type 1 (AGXT): BMN 307 / AAV5 at 7.3/10
...
OAV101-IT (Zolgensma) now ranks first for three diseases, forming a coherent CNS/AAV9 cluster:
...
The SMA match is the strongest internal validation point. Friedreich ataxia is biologically plausible for an AAV9 CNS/DRG approach. Kohlschutter-Tonz is lower-confidence biologically, though the platform class (intrathecal AAV9, small transgene, CNS target) is defensible.
...
The retinal cluster is biologically coherent. LHON's mitochondrial gene target is a special case not fully captured by the current nuclear gene-addition framework, and the dissertation should note this explicitly.

### 6. Haematopoietic / immune cluster

Strimvelis ranks first for three diseases:

- SCID-ADA (ADA): Strimvelis / LV at 8.1/10
- Wiskott-Aldrich syndrome (WAS): Strimvelis / LV at 8.0/10
- Usher syndrome type 1B (MYO7A): Strimvelis / LV at 6.5/10

The first two are biologically coherent HSC gene therapy targets. The Usher 1B match is a platform-class result — the cochlear/retinal delivery biology differs significantly from HSC-mediated correction, and the dissertation should flag this. SRP-9001 covers two muscle diseases (DMD at 7.6/10 and GSD type Ia at 7.8/10), and AT132 covers X-linked myotubular myopathy (7.7/10) as distinct muscle AAV8 precedents. Hemgenix ranks first for three liver-directed coagulation/metabolic diseases: Hemophilia B (9.9/10), Hemophilia A (8.5/10), and Crigler-Najjar syndrome type I (7.2/10).
...
"In a 46-disease proof-of-concept cohort, NanoGT generated interpretable precedent rankings for 45 diseases and correctly returned a packaging hard-fail for NF1 (8,451 bp CDS, exceeds all catalogued vectors). The 45 matched diseases clustered into biologically plausible precedent groups — integrating ex vivo HSC-vector lysosomal storage and immune programmes, lentiviral CNS leukodystrophy and neuronal, liver-directed metabolic AAV, intrathecal AAV9 CNS, and retinal AAV — while the NF1 packaging gate confirmed the framework's ability to flag large-gene cases outside single-vector scope. These findings support the feasibility of computational precedent matching for early-stage gene-therapy prioritisation, while highlighting the need for catalogue expansion, mechanism-source verification, improved pathway inference, and disease-specific expert review before translational use."
