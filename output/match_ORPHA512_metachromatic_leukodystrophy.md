# NanoGT Match Report: Metachromatic leukodystrophy

**Disease:** Metachromatic leukodystrophy (ORPHA:512)  
**Primary gene:** ARSA  
**Gene CDS:** 1521 bp  
...
**Mechanistic detail:** Arylsulfatase A lysosomal enzyme deficiency  
**Gene-addition compatibility:** compatible  
**Preferred modality class:** ex vivo hsc or cns gene addition  
**Evidence level/status:** direct / source_linked_needs_review  
**Evidence summary:** ARSA deficiency is compatible with gene addition and HSC-mediated enzyme delivery/cross-correction precedent  
...
| 2 | Skysona | LV | 8.6/10 | 🟢 High | approved |
| 3 | ABO-101 | AAV9 | 8.5/10 | 🟢 High | phase1/2 |
| 4 | RGX-121 | AAV9 | 8.5/10 | 🟢 High | phase3 |
| 5 | AVR-RD-01 | LV | 8.3/10 | 🟢 High | phase1/2 |
...
- Disease mechanism: loss of function — Arylsulfatase A lysosomal enzyme deficiency
...
- Mechanism source: OMIM ARSA gene entry (https://omim.org/entry/607574)
...
- ORGANELLE TARGETING: COMPATIBLE — ARSA standard subcellular localisation; nuclear AAV delivery directly produces functional protein at the correct cellular compartment with no additional organelle-import steps required.
...
- Gene CDS 1521bp / cargo 4700bp (32% utilized)
